...
public class ShareVideoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		PageInfo.preparedAndForwardSite(request, response, PageType.SITE_SHARE_PAGE);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String url="http://localhost:8080/Poly.Asg/Detail?videoId=";
			String videoId = request.getParameter("videoId");
			...
			if (videoId == null) {
				...
				mail.setSubject("Share favorite video");
				StringBuilder sb = new StringBuilder();
				sb.append("Dear Ms/Mr.<br>");
				sb.append("Check out this video <br>");
				sb.append("Please click the link <br>")
				.append("<a href='").append(url).append(videoId).append("'>here</a><br>");
				sb.append("Regards<br>");
				sb.append("Administrator<br>");

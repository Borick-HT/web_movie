			...
			<form action="" method="post">
				<div class="card">
							...
							<div class="col">
								...
								<div class="form-group">
									<label for="fullname">Fullname</label> <input type="text"
										...
										aria-describedby="fullnameHid" placeholder="Fulname">
					...
					<div class="card-footer text-muted">
						...
						<button class="btn btn-info"formaction="Admin/UserManagement/reset">Reset</button>
					</div>
				</div>
			</form>
		</div>
			...
			<table class="table table-stripe">
				...
				<tr>
					...
					<td><a href="Admin/UserManagement/edit?username=${item.username }"><i class="fa fa-edit" aria-hidden="true"></i>
							Edit</a> <a href="Admin/UserManagement/delete?username=${item.username }"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a>
					</td>
